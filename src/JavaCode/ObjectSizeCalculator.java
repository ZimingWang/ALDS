...
/**
 * Instrumentation is more accurate
 * http://yueyemaitian.iteye.com/blog/2033046
 * http://www.cnblogs.com/zhanjindong/p/3757767.html
 *
 *
 * Copied from  @author Kyrylo Holodnov
 * basic concept of java reflection
 *
 */
...
//We have reference graph with cycles.
    ...
    public static void main(String[] argv) throws IllegalAccessException {
        System.out.println(ObjectSizeCalculator.sizeOf(new String("s")));
        System.out.println(ObjectSizeCalculator.sizeOf(new Integer[0]));
        System.out.println(ObjectSizeCalculator.sizeOf(new HashMap(512)));
        int a = 1;
        System.out.println(ObjectSizeCalculator.sizeOf(new Object()));
        System.out.println(ObjectSizeCalculator.sizeOf(new A()));
    }
